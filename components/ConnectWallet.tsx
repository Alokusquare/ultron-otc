        ...
        return (
          ...
          >
            {(() => {
              if (!connected) {
                return (
                  <button onClick={openConnectModal} className="flex items-center gap-2 justify-center bg-[#FFFFFF14] hover:bg-green-950 text-sm text-white rounded-md py-2 px-3 transition-colors ">
                    <img src="/images/metamask.png" alt="Metamask" className="w-5 h-5 " />
                    <span>Metamask</span>
                  </button>
                )
              }
