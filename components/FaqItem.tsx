...
export const FaqItem = ({ value, question, answer }: FaqItemProps) => {
  return (
    <AccordionItem
      value={value}
      className="border border-gray-800 !rounded-[15px] overflow-hidden bg-[#f5f5f5]"
    >
      <AccordionTrigger className="px-6 py-4 text-left hover:bg-[#f5f5f5] text-black transition-colors font-medium">
        {question}
      </AccordionTrigger>
