      ...
      <div className="flex justify-around">
        ...
        <main className="p-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Balance Card */}
            <div className="lg:col-span-2  bg-[#0c0e18] border border-green-900/20 rounded-xl p-6 flex flex-col justify-between"
             style={{
            ...
            >
              <div>
                ...
                <div className="flex justify-between items-center mb-8">
                  <div className="text-3xl font-bold textard">2.54 BTC</div>
                  <div className="text-3xl font-bold textard">AED 365,500</div>
                </div>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <div className="flex-1 md:pl-8 pl-3">
                  <div className="flex items-center justify-end text-red-500 mb-2">
                    <ArrowDown className="h-4 w-4 mr-2" />
                    <span className="text-gray-300">Expenses</span>
                  </div>
                  <div className="text-lg text-right">AED 8.769,04</div>
                </div>
              </div>
          ...
          {/* Recent Orders */}
          <div className="rounded-[16px] overflow-hidden mt-6">
          <div className="rounded-[16px] gradient-border  md:p-6 p-3">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-4 bg-[#1a1d2d]/30 rounded-lg">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 bg-[#0c1a14] rounded-full flex items-center justify-center re_his_hide">
              ...
              <div className="flex justify-between items-center p-4 bg-[#1a1d2d]/30 rounded-lg">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 bg-[#1a0c14] rounded-full flex items-center justify-center re_his_hide">
