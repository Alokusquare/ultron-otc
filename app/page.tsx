          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="flex justify-between flex-col gap-16">
              <div className="flex flex-row items-center justify-between text-center mb-12">
                <StepCard number={1} title="Send Crypto" description='Choose your cryptocurrency and amount. Send to our secure wallet with competitive rates.' />
                <StepCard number={2} title="Track Delivery" description='Monitor your transaction in real-time through our encrypted tracking system.' />
              </div>
              <StepCard number={3} title="Receive Cash" description='Our verified courier delivers cash directly to your specified location in Dubai.' />
            </div>
          </div>
        </section>
